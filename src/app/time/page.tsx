...
import { RevenueSummary } from '@/components/time/RevenueSummary';
import { MonthlyBilling } from '@/components/time/MonthlyBilling';
...
export default function TimePage(): React.ReactElement {
  ...
  return (
    <div>
      ...
      {timeData && <RevenueSummary entries={timeData.entries} />}
